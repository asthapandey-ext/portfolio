          ...
          <figure className="hero-visual reveal delay-2" data-testid="figure-portrait">
            <div className="hero-visual-row">
              <div className="portrait-banner">
                ...
                <img className="portrait-backdrop" src="src={`${import.meta.env.BASE_URL}assets/astha-portrait.png`}" alt="" aria-hidden="true" />
              ...
              <div className="profile-panel">
                ...
                <div className="portrait-orbit">
                  ...
                  <img className="portrait portrait-circle" src={`${import.meta.env.BASE_URL}assets/astha-portrait.png`}" alt="Astha Pandey working at her desk" />
                </div>
